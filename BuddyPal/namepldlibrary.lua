...
function LoadSettings()
    ...
    sets.NA.Mode = {'IDLE','PDT','MDT'}
        ...
        {ammo  = "Vanir Battery",
         ...
         back  = "Weard Mantle",
         waist = "Flume Belt",
         legs  = { name="Odyssean Cuisses", augments={'Enmity+5','STR+9','"Refresh"+2','Accuracy+10 Attack+10',}},
         feet  = "Amm Greaves"}
    ...
    sets.WSATT = {}
        ...
        {ammo  = "Amar Cluster",
         ...
         hands = { name="Odyssean Gauntlets", augments={'Accuracy+18 Attack+18','Accuracy+12','Attack+2',}},
         ring1 = "Ifrit Ring",
         ring2 = "Petrov Ring",
         back  = "Weard Mantle",
         waist = "Prosilio Belt",
         legs  = { name="Odyssean Cuisses", augments={'Enmity+5','STR+9','"Refresh"+2','Accuracy+10 Attack+10',}},
         feet  = { name="Odyssean Greaves", augments={'Accuracy+12','Weapon skill damage +4%','STR+15','Attack+14',}}}
