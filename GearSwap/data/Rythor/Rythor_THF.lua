...
function init_gear_sets()
	...
	sets.precast.WS = {
		head={ name="Herculean Helm", augments={'Accuracy+11 Attack+11','Weapon skill damage +2%','STR+7','Accuracy+1','Attack+2',}},
		body={ name="Samnuha Coat", augments={'Mag. Acc.+2','"Dual Wield"+1',}},
		hands={ name="Herculean Gloves", augments={'Accuracy+12 Attack+12','Weapon skill damage +3%','Accuracy+14','Attack+1',}},
		legs={ name="Herculean Trousers", augments={'Attack+30','Weapon skill damage +2%','STR+15','Accuracy+12',}},
		feet={ name="Herculean Boots", augments={'Weapon skill damage +3%','STR+14','Accuracy+14',}},
		neck="Houyi's Gorget",
		waist="Cetl Belt",
...
-- Midcast Sets --
	...
	-- Idle sets
	sets.idle = {
		head={ name="Herculean Helm", augments={'Accuracy+17 Attack+17','"Triple Atk."+2','AGI+14',}},
		body={ name="Samnuha Coat", augments={'Mag. Acc.+2','"Dual Wield"+1',}},
		hands={ name="Herculean Gloves", augments={'Accuracy+29','Damage taken-3%','AGI+3','Attack+13',}},
		legs={ name="Herculean Trousers", augments={'Attack+30','Weapon skill damage +2%','STR+15','Accuracy+12',}},
		feet="Fajin Boots",
