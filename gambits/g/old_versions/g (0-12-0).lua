...
function process_selector(selector, trigger, trigger_arg, gambit_num)
  local valid_self_triggers = S{"STATUS","NOT_STATUS","NOT_ENGAGED","NOT_ASSISTING","TP >=","HPP <=","HPP >","MA_READY","JA_READY","SHADOWS <","MOVES <","MOVES >=","CAN_SC","CAN_MB"}
  ...
  local triggers_with_raw_args = S{"HPP <=","HPP >","TP >=","NOT_ENGAGED","NOT_ASSISTING","SHADOWS <","MOVES <","MOVES >=","CAN_SC","CAN_MB"}
